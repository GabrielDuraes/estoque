...
<?php
    ...
    $Usuario = new User();
    $Usuario = $Usuario->Read($_SESSION['id_user']);
?>
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form>
                                    ...
                                    <?php }else { ?>
                                    <input type="hidden" id="nivel_acesso" value="<?php echo $Usuario['nivel_acesso'] ?>">
                                    <input type="hidden" id="loja" value="<?php echo $Usuario['loja'] ?>">
