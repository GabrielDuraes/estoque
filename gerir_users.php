...
?>
        ...
        <div class="row">
        <h3 class="text-center" style="margin-top: 0px;">Gerenciar Usuários</h3>
            <div class="col-md-3">
                <button class="btn btn-default btn-block" data-toggle="modal" data-target="#adduser">Adicionar Usuário</button>
                <br>
            </div>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control border-input" id="nome_user" value="<?php echo $Usuario['senha_user'] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="exampleInputEmail1">Email *</label>
                            <input type="text" class="form-control border-input" id="email_user" value="<?php echo $Usuario['senha_user'] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="exampleInputEmail1">Senha *</label>
                            <input type="password" class="form-control border-input" id="senha_user" value="<?php echo $Usuario['senha_user'] ?>">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nivel_acesso">Loja *</label>
                                <select class="form-control" id="loja">
                                <option value="" selcted>Selecione . . .</option>
                                <option value="Diamantina">Diamantina</option>
                                <option value="P.Kubitschek">P.Kubitschek</option>
